...
@pytest.fixture
def pessoa_valida():
    engenheiro = Engenheiro("Caio", "1234-5678", "Caioreal@gmail.com", Endereco("Rua Fernando de Noronha", "6", "N/A", "4128", "Salvador"), "2345")
    return engenheiro
...
def test_crea_tipo_invalido():
    with pytest.raises(TypeError, match="O crea deve se manter como tipo texto!"):
        Engenheiro("Caio", "1234-5678", "Caioreal@gmail.com", Endereco("Rua Fernando de Noronha", "6", "N/A", "4128", "Salvador"), "2345")